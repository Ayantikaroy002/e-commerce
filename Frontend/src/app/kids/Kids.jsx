  ...
  return (
    <>
     <div className="flex flex-row bg-[#e1dedb] h-[600px] pb-6">
          ...
          <img className=" w-full h-[500px] mb-5 " src="../men.jpg" alt="" />
      ...
      <div className="py-8 bg-[#e1dedb]">
        ...
        <div class="flex flex-row mx-32 bg-black my-14 h-[400px]">
          <div class="left flex flex-col mt-10 ">
            <h1 class="text-3xl px-6 font-bold text-white">
              GET YOURSELF INTO THE RIGHT GEAR
            </h1>
            <p class="w-3/4 pl-7 pt-56 text-white">
              Many women are afraid to try something new at work because they
              think that that they will not be taken seriously.
            </p>
          </div>
          <div class="right  w-[49%]">
            <img class="h-[400px] " src="../men.jpg" alt="" />
          </div>
        </div>
      </div>
    </>

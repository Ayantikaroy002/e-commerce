      ...
      <section className="bg-[#e1dedb] h-[90vh] overflow-hidden">
        <div className="h-[100%] mx-6 p-8 ">
          ...
          <div className="h-[100%] relative grid grid-flow-col gap-2 items-stretch">
            ...
            <Link href="/kid-category/Shirts" className="group relative block bg-black">
              <img
                alt=""
            ...
            <Link href="/kid-category/T-shirts" className="group relative block bg-black">
              <img
                alt=""
                src="https://images.unsplash.com/photo-1603871165848-0aa92c869fa1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=772&q=80"
                className="absolute inset-0 h-full w-full object-cover opacity-75 transition-opacity group-hover:opacity-50"
            ...
            <Link href="/kid-category/Frocks" className="group relative block bg-black">
              <img
                alt=""
                src="https://images.unsplash.com/photo-1603871165848-0aa92c869fa1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=772&q=80"
                className="absolute inset-0 h-full w-full object-cover opacity-75 transition-opacity group-hover:opacity-50"
              ...
              <div className="relative p-4 sm:p-6 lg:p-8">
                ...
                <p className="text-xl font-bold text-white sm:text-2xl">Frocks</p>
            ...
            <Link href="/kid-category/Hoodies" className="group relative block bg-black">
              <img
                alt=""
                src="https://images.unsplash.com/photo-1603871165848-0aa92c869fa1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=772&q=80"
                className="absolute inset-0 h-full w-full object-cover opacity-75 transition-opacity group-hover:opacity-50"
            ...
            <Link href="/kid-category/Tops" className="group relative block bg-black">
              <img
                alt=""
                src="https://images.unsplash.com/photo-1603871165848-0aa92c869fa1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=772&q=80"
                className="absolute inset-0 h-full w-full object-cover opacity-75 transition-opacity group-hover:opacity-50"
              ...
              <div className="relative p-4 sm:p-6 lg:p-8">
                ...
                <p className="text-xl font-bold text-white sm:text-2xl">Tops</p>
